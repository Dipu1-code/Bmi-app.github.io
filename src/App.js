      ...
      <div className="App">
        <div className="App-header">
          ...
          <form onSubmit={this.submitMe}>
            ...
            <label>{this.state.checked} Hello {this.state.name}, How are you my friend? It's currently  {this.state.time} </label>
            ...
            <input type= "text" name='bmi' value={this.state.bmi}/>
